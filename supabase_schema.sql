-- ============================================================================
-- KOSOVO NATIONAL FOOTBALL TEAM — Supabase PostgreSQL Schema
-- Dark-themed professional website backend
...
CREATE POLICY "auth_update_players"  ON players FOR UPDATE  TO authenticated USING (true);
CREATE POLICY "auth_delete_players"  ON players FOR DELETE  TO authenticated USING (true);

-- ============================================================================
-- 3. FIXTURES  (upcoming & past matches)
-- ============================================================================
...
CREATE POLICY "public_read_fixtures"  ON fixtures FOR SELECT  TO anon, authenticated USING (true);
CREATE POLICY "auth_insert_fixtures"  ON fixtures FOR INSERT  TO authenticated WITH CHECK (true);
CREATE POLICY "auth_update_fixtures"  ON fixtures FOR UPDATE  TO authenticated USING (true);
CREATE POLICY "auth_delete_fixtures"  ON fixtures FOR DELETE  TO authenticated USING (true);
...
CREATE POLICY "public_read_published" ON news FOR SELECT TO anon, authenticated USING (is_published = true);
CREATE POLICY "auth_manage_news"       ON news FOR ALL    TO authenticated     USING (true) WITH CHECK (true);

-- ============================================================================
-- 5. SUBSCRIBERS  (fan newsletter)
-- ============================================================================
...
CREATE POLICY "auth_manage_subscribers" ON subscribers FOR ALL    TO authenticated USING (true) WITH CHECK (true);

-- ============================================================================
-- SEED DATA — initial squad (20 players)
-- ============================================================================
